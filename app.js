...
const chemistryData = {
  ...
  terms: [
    ...
    { name: 'Phosphoric Acid', iupac: 'Phosphoric acid', formula: 'H₃PO₄', molecular_mass: 97.994, type: 'Inorganic', description: 'Weak triprotic acid, rust converter', state: 'Colorless solid/liquid', melting_point: '42.4°C', boiling_point: '158°C', density: '1.88 g/cm³', uses: 'Soft drinks, rust removal, fertilizers', properties: 'Triprotic acid, non-toxic, used in cola' },
    { name: 'Vitamin C', iupac: 'Ascorbic acid', formula: 'C₆H₈O₆', molecular_mass: 176.12, type: 'Organic', description: 'Essential nutrient, antioxidant', state: 'White solid', melting_point: '190°C', density: '1.65 g/cm³', uses: 'Dietary supplement, antioxidant, food preservative', properties: 'Water-soluble vitamin, reduces free radicals' },
    { name: 'Butane', iupac: 'Butane', formula: 'C₄H₁₀', molecular_mass: 58.12, type: 'Organic', description: 'Hydrocarbon fuel, lighter fuel', state: 'Gas', melting_point: '-138°C', boiling_point: '-1°C', density: '2.48 kg/m³', uses: 'Fuel, propellant, refrigerant', properties: 'Highly flammable, colorless' },
    { name: 'Pentane', iupac: 'Pentane', formula: 'C₅H₁₂', molecular_mass: 72.15, type: 'Organic', description: 'Hydrocarbon solvent', state: 'Liquid', melting_point: '-130°C', boiling_point: '36°C', density: '0.626 g/mL', uses: 'Solvent, blowing agent', properties: 'Volatile, flammable' },
    { name: 'Hexane', iupac: 'Hexane', formula: 'C₆H₁₄', molecular_mass: 86.18, type: 'Organic', description: 'Non-polar solvent', state: 'Liquid', melting_point: '-95°C', boiling_point: '69°C', density: '0.655 g/mL', uses: 'Extraction solvent, cleaning', properties: 'Non-polar, low boiling point' },
    { name: 'Heptane', iupac: 'Heptane', formula: 'C₇H₁₆', molecular_mass: 100.2, type: 'Organic', description: 'Hydrocarbon fuel component', state: 'Liquid', melting_point: '-91°C', boiling_point: '98°C', density: '0.684 g/mL', uses: 'Fuel, solvent', properties: 'Reference fuel standard' },
    { name: 'Octane', iupac: 'Octane', formula: 'C₈H₁₈', molecular_mass: 114.23, type: 'Organic', description: 'Gasoline component', state: 'Liquid', melting_point: '-57°C', boiling_point: '126°C', density: '0.703 g/mL', uses: 'Fuel, octane rating standard', properties: 'Major component of gasoline' },
    { name: 'Naphthalene', iupac: 'Naphthalene', formula: 'C₁₀H₈', molecular_mass: 128.17, type: 'Organic', description: 'Aromatic hydrocarbon, mothballs', state: 'White solid', melting_point: '80°C', boiling_point: '218°C', density: '1.14 g/cm³', uses: 'Mothballs, PVC plasticizer', properties: 'Sublimes readily, aromatic' },
    { name: 'Anthracene', iupac: 'Anthracene', formula: 'C₁₄H₁₀', molecular_mass: 178.23, type: 'Organic', description: 'Polycyclic aromatic hydrocarbon', state: 'Solid', melting_point: '216°C', boiling_point: '340°C', density: '1.28 g/cm³', uses: 'Dye precursor, scintillator', properties: 'Blue fluorescence' },
    { name: 'Phenol', iupac: 'Hydroxybenzene', formula: 'C₆H₅OH', molecular_mass: 94.11, type: 'Organic', description: 'Aromatic alcohol, antiseptic', state: 'White solid', melting_point: '41°C', boiling_point: '182°C', density: '1.07 g/cm³', uses: 'Disinfectant, plastics, pharmaceuticals', properties: 'Weak acid, antiseptic' },
    { name: 'Aniline', iupac: 'Aminobenzene', formula: 'C₆H₅NH₂', molecular_mass: 93.13, type: 'Organic', description: 'Aromatic amine', state: 'Oily liquid', melting_point: '-6°C', boiling_point: '184°C', density: '1.02 g/mL', uses: 'Dye manufacturing, rubber', properties: 'Weak base, toxic' },
    { name: 'Styrene', iupac: 'Vinylbenzene', formula: 'C₈H₈', molecular_mass: 104.15, type: 'Organic', description: 'Polymer precursor', state: 'Liquid', melting_point: '-31°C', boiling_point: '145°C', density: '0.906 g/mL', uses: 'Polystyrene production, plastics', properties: 'Polymerizes readily' },
    { name: 'Xylene', iupac: 'Dimethylbenzene', formula: 'C₈H₁₀', molecular_mass: 106.16, type: 'Organic', description: 'Aromatic solvent', state: 'Liquid', melting_point: '-47°C', boiling_point: '144°C', density: '0.864 g/mL', uses: 'Solvent, fuel additive', properties: 'Three isomers exist' },
    { name: 'Pyridine', iupac: 'Azine', formula: 'C₅H₅N', molecular_mass: 79.10, type: 'Organic', description: 'Aromatic heterocycle', state: 'Liquid', melting_point: '-42°C', boiling_point: '115°C', density: '0.982 g/mL', uses: 'Solvent, pharmaceutical synthesis', properties: 'Basic, water-miscible' },
    { name: 'Morphine', iupac: 'Morphinan-3,6-diol', formula: 'C₁₇H₁₉NO₃', molecular_mass: 285.34, type: 'Organic', description: 'Opioid analgesic alkaloid', state: 'White powder', melting_point: '254°C', density: '1.32 g/cm³', uses: 'Pain relief, controlled substance', properties: 'Highly addictive, narcotic' },
    { name: 'Codeine', iupac: 'Methylmorphine', formula: 'C₁₈H₂₁NO₃', molecular_mass: 299.36, type: 'Organic', description: 'Opioid analgesic', state: 'White powder', melting_point: '155°C', density: '1.32 g/cm³', uses: 'Cough suppressant, pain relief', properties: 'Less potent than morphine' },
    { name: 'Nicotine', iupac: '3-Pyridylmethylpyrrolidine', formula: 'C₁₀H₁₄N₂', molecular_mass: 162.23, type: 'Organic', description: 'Stimulant alkaloid from tobacco', state: 'Oily liquid', melting_point: '-79°C', boiling_point: '247°C', density: '1.01 g/mL', uses: 'Insecticide, addiction', properties: 'Highly toxic, addictive' },
    { name: 'Quinine', iupac: 'Quinoline alkaloid', formula: 'C₂₀H₂₄N₂O₂', molecular_mass: 324.42, type: 'Organic', description: 'Antimalarial drug', state: 'White solid', melting_point: '177°C', density: '1.62 g/cm³', uses: 'Malaria treatment, tonic water', properties: 'Fluorescent, bitter taste' },
    { name: 'Ibuprofen', iupac: 'Isobutylphenylpropanoic acid', formula: 'C₁₃H₁₈O₂', molecular_mass: 206.28, type: 'Organic', description: 'Non-steroidal anti-inflammatory', state: 'White solid', melting_point: '76°C', density: '1.03 g/cm³', uses: 'Pain relief, fever reduction', properties: 'NSAID, widely used' },
    { name: 'Paracetamol', iupac: 'N-acetyl-p-aminophenol', formula: 'C₈H₉NO₂', molecular_mass: 151.16, type: 'Organic', description: 'Analgesic and antipyretic', state: 'White solid', melting_point: '169°C', density: '1.26 g/cm³', uses: 'Pain relief, fever reduction', properties: 'Safe in recommended doses' },
    { name: 'Penicillin', iupac: 'β-lactam antibiotic', formula: 'C₁₆H₁₈N₂O₄S', molecular_mass: 334.39, type: 'Organic', description: 'First antibiotic discovered', state: 'White powder', melting_point: '214°C', density: '1.41 g/cm³', uses: 'Bacterial infections', properties: 'β-lactam ring, bactericidal' },
    { name: 'Dopamine', iupac: '3,4-Dihydroxyphenethylamine', formula: 'C₈H₁₁NO₂', molecular_mass: 153.18, type: 'Organic', description: 'Neurotransmitter', state: 'White solid', melting_point: '128°C', density: '1.36 g/cm³', uses: 'Reward system, movement', properties: 'Pleasure neurotransmitter' },
    { name: 'Serotonin', iupac: '5-Hydroxytryptamine', formula: 'C₁₀H₁₂N₂O', molecular_mass: 176.22, type: 'Organic', description: 'Mood neurotransmitter', state: 'White solid', melting_point: '167°C', density: '1.34 g/cm³', uses: 'Mood regulation', properties: 'Happiness hormone' },
    { name: 'Adrenaline', iupac: 'Epinephrine', formula: 'C₉H₁₃NO₃', molecular_mass: 183.20, type: 'Organic', description: 'Fight-or-flight hormone', state: 'White solid', melting_point: '211°C', density: '1.31 g/cm³', uses: 'Anaphylaxis, cardiac arrest', properties: 'Stress hormone, vasoconstrictor' },
    { name: 'Testosterone', iupac: '17β-Hydroxyandrost-4-en-3-one', formula: 'C₁₉H₂₈O₂', molecular_mass: 288.42, type: 'Organic', description: 'Male sex hormone', state: 'White solid', melting_point: '155°C', density: '1.12 g/cm³', uses: 'Hormone therapy, athletics', properties: 'Anabolic steroid' },
    { name: 'Estrogen', iupac: 'Estradiol', formula: 'C₁₈H₂₄O₂', molecular_mass: 272.38, type: 'Organic', description: 'Female sex hormone', state: 'White solid', melting_point: '178°C', density: '1.27 g/cm³', uses: 'Hormone therapy, contraception', properties: 'Steroid hormone' },
    { name: 'Cholesterol', iupac: 'Cholest-5-en-3β-ol', formula: 'C₂₇H₄₆O', molecular_mass: 386.65, type: 'Organic', description: 'Essential lipid', state: 'White solid', melting_point: '148°C', density: '1.05 g/cm³', uses: 'Cell membranes, hormones', properties: 'Vital but can be harmful' },
    { name: 'Retinol', iupac: 'Vitamin A', formula: 'C₂₀H₃₀O', molecular_mass: 286.45, type: 'Organic', description: 'Essential vitamin for vision', state: 'Yellow solid', melting_point: '64°C', density: '0.945 g/cm³', uses: 'Vision, skin health', properties: 'Fat-soluble vitamin' },
    { name: 'Vitamin D', iupac: 'Cholecalciferol', formula: 'C₂₇H₄₄O', molecular_mass: 384.64, type: 'Organic', description: 'Bone health vitamin', state: 'White solid', melting_point: '84°C', density: '0.96 g/cm³', uses: 'Calcium absorption, bones', properties: 'Synthesized from sunlight' },
    { name: 'Vitamin E', iupac: 'α-Tocopherol', formula: 'C₂₉H₅₀O₂', molecular_mass: 430.71, type: 'Organic', description: 'Antioxidant vitamin', state: 'Viscous oil', melting_point: '3°C', density: '0.95 g/mL', uses: 'Antioxidant, skin protection', properties: 'Fat-soluble, protects cells' },
    { name: 'Vitamin K', iupac: 'Phylloquinone', formula: 'C₃₁H₄₆O₂', molecular_mass: 450.70, type: 'Organic', description: 'Blood clotting vitamin', state: 'Yellow oil', melting_point: '-20°C', density: '0.97 g/mL', uses: 'Blood coagulation', properties: 'Essential for clotting' },
    { name: 'Folic Acid', iupac: 'Vitamin B9', formula: 'C₁₉H₁₉N₇O₆', molecular_mass: 441.40, type: 'Organic', description: 'Essential B vitamin', state: 'Yellow solid', melting_point: '250°C', density: '1.64 g/cm³', uses: 'DNA synthesis, pregnancy', properties: 'Prevents neural defects' },
    { name: 'Riboflavin', iupac: 'Vitamin B2', formula: 'C₁₇H₂₀N₄O₆', molecular_mass: 376.36, type: 'Organic', description: 'B vitamin', state: 'Yellow-orange', melting_point: '290°C', density: '1.65 g/cm³', uses: 'Energy metabolism', properties: 'Yellow fluorescence' },
    { name: 'Niacin', iupac: 'Vitamin B3', formula: 'C₆H₅NO₂', molecular_mass: 123.11, type: 'Organic', description: 'B vitamin', state: 'White solid', melting_point: '237°C', density: '1.47 g/cm³', uses: 'Energy metabolism', properties: 'Prevents pellagra' },
    { name: 'Thiamine', iupac: 'Vitamin B1', formula: 'C₁₂H₁₇N₄OS', molecular_mass: 265.35, type: 'Organic', description: 'Essential B vitamin', state: 'White solid', melting_point: '248°C', density: '1.32 g/cm³', uses: 'Nervous system, metabolism', properties: 'Prevents beriberi' },
    { name: 'Biotin', iupac: 'Vitamin B7', formula: 'C₁₀H₁₆N₂O₃S', molecular_mass: 244.31, type: 'Organic', description: 'B vitamin', state: 'White solid', melting_point: '232°C', density: '1.36 g/cm³', uses: 'Metabolism, hair health', properties: 'Essential coenzyme' }
  ],
  reactions: [
    ...
    { name: 'Fischer Esterification', equation: 'R-COOH + R\'OH → R-COOR\' + H₂O', type: 'Organic', description: 'Acid-catalyzed formation of esters', energy: 'Equilibrium reaction', conditions: 'H₂SO₄ catalyst, reflux, Dean-Stark trap' },
    { name: 'Williamson Ether Synthesis', equation: 'R-ONa + R\'X → R-O-R\' + NaX', type: 'Organic', description: 'SN2 formation of ethers', energy: 'Exothermic', conditions: 'Strong base, primary alkyl halide' },
    { name: 'Gabriel Synthesis', equation: 'Phthalimide + RX → R-NH₂', type: 'Organic', description: 'Synthesis of primary amines', energy: 'Multi-step', conditions: 'KOH, hydrazine workup' },
    { name: 'Sandmeyer Reaction', equation: 'ArN₂⁺ + CuX → ArX + N₂', type: 'Organic', description: 'Replacement of diazonium with halogen', energy: 'Exothermic', conditions: 'Copper(I) salts, 0-5°C' },
    { name: 'Kolbe Electrolysis', equation: '2RCOO⁻ → R-R + 2CO₂', type: 'Organic', description: 'Electrochemical coupling of carboxylates', energy: 'Requires electrical energy', conditions: 'Electrolysis, platinum electrodes' },
    { name: 'Birch Reduction', equation: 'Benzene + Na/NH₃ → 1,4-Cyclohexadiene', type: 'Reduction', description: 'Partial reduction of aromatics', energy: 'Exothermic', conditions: 'Sodium in liquid ammonia, alcohol' },
    { name: 'Wolff-Kishner Reduction', equation: 'R-CO-R\' → R-CH₂-R\'', type: 'Reduction', description: 'Reduction of ketones to alkanes', energy: 'Exothermic', conditions: 'Hydrazine, KOH, high temperature' },
    { name: 'Clemmensen Reduction', equation: 'R-CO-R\' → R-CH₂-R\'', type: 'Reduction', description: 'Reduction of carbonyls with Zn-Hg', energy: 'Exothermic', conditions: 'Zinc amalgam, HCl' },
    { name: 'Mannich Reaction', equation: 'R-CHO + R\'NH₂ + R\"COCH₃ → Mannich base', type: 'Condensation', description: 'Three-component condensation', energy: 'Exothermic', conditions: 'Acidic conditions, formaldehyde' },
    { name: 'Perkin Reaction', equation: 'ArCHO + (RCO)₂O → ArCH=CHCOOH', type: 'Condensation', description: 'Synthesis of cinnamic acids', energy: 'Exothermic', conditions: 'Base catalyst, anhydride' },
    { name: 'Knoevenagel Condensation', equation: 'R-CHO + CH₂(COOR)₂ → R-CH=C(COOR)₂', type: 'Condensation', description: 'Condensation with active methylene', energy: 'Exothermic', conditions: 'Weak base, piperidine' },
    { name: 'Michael Addition', equation: 'α,β-unsaturated + Nucleophile → 1,4-Addition', type: 'Addition', description: 'Conjugate addition to enones', energy: 'Exothermic', conditions: 'Base catalyst, nucleophile' },
    { name: 'Robinson Annulation', equation: 'Enone + Ketone → Cyclohexenone', type: 'Cycloaddition', description: 'Michael + Aldol condensation', energy: 'Exothermic', conditions: 'Base, sequential reaction' },
    { name: 'Wittig Reaction', equation: 'R-CHO + Ph₃P=CHR\' → R-CH=CHR\'', type: 'Olefination', description: 'Conversion of carbonyl to alkene', energy: 'Exothermic', conditions: 'Phosphonium ylide' },
    { name: 'Horner-Wadsworth-Emmons', equation: 'R-CHO + Phosphonate → E-Alkene', type: 'Olefination', description: 'E-selective Wittig variant', energy: 'Exothermic', conditions: 'Base, phosphonate ester' },
    { name: 'Reformatsky Reaction', equation: 'R-CHO + BrCH₂COOR\' → R-CH(OH)CH₂COOR\'', type: 'Addition', description: 'Organozinc addition to carbonyl', energy: 'Exothermic', conditions: 'Zinc, THF solvent' },
    { name: 'Suzuki Coupling', equation: 'R-Br + R\'-B(OH)₂ → R-R\'', type: 'Cross-coupling', description: 'Palladium-catalyzed C-C bond formation', energy: 'Exothermic', conditions: 'Pd catalyst, base, 80°C' },
    { name: 'Heck Reaction', equation: 'R-X + Alkene → R-Alkene', type: 'Cross-coupling', description: 'Palladium-catalyzed alkene arylation', energy: 'Exothermic', conditions: 'Pd catalyst, base, 100°C' },
    { name: 'Sonogashira Coupling', equation: 'R-X + HC≡CR\' → R-C≡CR\'', type: 'Cross-coupling', description: 'Pd-catalyzed alkyne coupling', energy: 'Exothermic', conditions: 'Pd/Cu catalyst, base' },
    { name: 'Negishi Coupling', equation: 'R-X + R\'ZnX → R-R\'', type: 'Cross-coupling', description: 'Organozinc coupling', energy: 'Exothermic', conditions: 'Pd or Ni catalyst' },
    { name: 'Stille Coupling', equation: 'R-X + R\'SnBu₃ → R-R\'', type: 'Cross-coupling', description: 'Organotin coupling', energy: 'Exothermic', conditions: 'Pd catalyst, mild conditions' },
    { name: 'Buchwald-Hartwig Amination', equation: 'Ar-X + R₂NH → Ar-NR₂', type: 'Cross-coupling', description: 'Palladium-catalyzed C-N coupling', energy: 'Exothermic', conditions: 'Pd catalyst, strong base' },
    { name: 'Ullmann Coupling', equation: '2Ar-X + Cu → Ar-Ar', type: 'Homocoupling', description: 'Copper-mediated biaryl synthesis', energy: 'Endothermic', conditions: 'Copper, high temperature' },
    { name: 'Sharpless Epoxidation', equation: 'Allylic alcohol + Ti/TBHP → Epoxy alcohol', type: 'Oxidation', description: 'Enantioselective epoxidation', energy: 'Exothermic', conditions: 'Titanium catalyst, chiral ligand' },
    { name: 'Sharpless Dihydroxylation', equation: 'Alkene + OsO₄ → syn-Diol', type: 'Oxidation', description: 'Enantioselective dihydroxylation', energy: 'Exothermic', conditions: 'Osmium catalyst, K₃Fe(CN)₆' },
    { name: 'Swern Oxidation', equation: 'R-CH₂OH → R-CHO', type: 'Oxidation', description: 'Mild oxidation to aldehyde', energy: 'Exothermic', conditions: 'DMSO, oxalyl chloride, -78°C' },
    { name: 'Jones Oxidation', equation: 'R-CH₂OH → R-COOH', type: 'Oxidation', description: 'Strong chromic acid oxidation', energy: 'Exothermic', conditions: 'CrO₃, H₂SO₄, acetone' },
    { name: 'PCC Oxidation', equation: 'R-CH₂OH → R-CHO', type: 'Oxidation', description: 'Mild chromium oxidation', energy: 'Exothermic', conditions: 'Pyridinium chlorochromate, CH₂Cl₂' },
    { name: 'Corey-Kim Oxidation', equation: 'R-CH₂OH → R-CHO', type: 'Oxidation', description: 'NCS/DMS oxidation', energy: 'Exothermic', conditions: 'N-chlorosuccinimide, dimethyl sulfide' },
    { name: 'Ozonolysis', equation: 'R-CH=CH-R\' → R-CHO + R\'-CHO', type: 'Oxidation', description: 'Cleavage of alkenes', energy: 'Exothermic', conditions: 'O₃, -78°C, then workup' },
    { name: 'Baeyer-Villiger Oxidation', equation: 'Ketone + Peracid → Ester', type: 'Oxidation', description: 'Insertion of oxygen into C-C bond', energy: 'Exothermic', conditions: 'mCPBA or peracid' },
    { name: 'Oxidative Cleavage', equation: 'Alkene + KMnO₄ → Carboxylic acids', type: 'Oxidation', description: 'Complete cleavage to acids', energy: 'Exothermic', conditions: 'Hot alkaline KMnO₄' },
    { name: 'Epoxidation', equation: 'Alkene + RCO₃H → Epoxide', type: 'Oxidation', description: 'Formation of three-membered ether', energy: 'Exothermic', conditions: 'Peracid, room temperature' },
    { name: 'Hydroboration-Oxidation', equation: 'Alkene → Anti-Markovnikov alcohol', type: 'Addition', description: 'Syn-addition then oxidation', energy: 'Two-step', conditions: 'BH₃, then H₂O₂/NaOH' },
    { name: 'Oxymercuration-Demercuration', equation: 'Alkene → Markovnikov alcohol', type: 'Addition', description: 'Mercury-mediated hydration', energy: 'Two-step', conditions: 'Hg(OAc)₂, then NaBH₄' },
    { name: 'Catalytic Hydrogenation', equation: 'Alkene + H₂ → Alkane', type: 'Reduction', description: 'Addition of hydrogen', energy: 'Exothermic', conditions: 'Pt, Pd, or Ni catalyst, H₂' },
    { name: 'Lindlar Reduction', equation: 'Alkyne → cis-Alkene', type: 'Reduction', description: 'Partial reduction of alkynes', energy: 'Exothermic', conditions: 'Lindlar catalyst, H₂, quinoline' },
    { name: 'Birch Reduction of Alkynes', equation: 'Alkyne → trans-Alkene', type: 'Reduction', description: 'Dissolving metal reduction', energy: 'Exothermic', conditions: 'Na/NH₃, alcohol' },
    { name: 'Pinacol Rearrangement', equation: 'Vicinal diol → Ketone', type: 'Rearrangement', description: 'Acid-catalyzed 1,2-shift', energy: 'Exothermic', conditions: 'H⁺ catalyst, heating' },
    { name: 'Wagner-Meerwein Rearrangement', equation: 'Carbocation → Rearranged carbocation', type: 'Rearrangement', description: 'Alkyl/hydride shift', energy: 'Variable', conditions: 'Carbocation intermediate' },
    { name: 'Beckmann Rearrangement', equation: 'Oxime → Amide', type: 'Rearrangement', description: 'Acid-catalyzed rearrangement', energy: 'Exothermic', conditions: 'Strong acid, PCl₅, or H₂SO₄' },
    { name: 'Hofmann Rearrangement', equation: 'Amide + Br₂/NaOH → Amine', type: 'Rearrangement', description: 'Loss of CO₂, one carbon shorter', energy: 'Exothermic', conditions: 'Bromine, base, heating' },
    { name: 'Curtius Rearrangement', equation: 'Acyl azide → Isocyanate → Amine', type: 'Rearrangement', description: 'Thermal rearrangement', energy: 'Endothermic', conditions: 'Heat, then hydrolysis' },
    { name: 'Schmidt Rearrangement', equation: 'Ketone + HN₃ → Amide', type: 'Rearrangement', description: 'Acid-catalyzed nitrogen insertion', energy: 'Exothermic', conditions: 'Hydrazoic acid, H₂SO₄' },
    { name: 'Wolff Rearrangement', equation: 'α-Diazo ketone → Ketene', type: 'Rearrangement', description: 'Photochemical or thermal', energy: 'Variable', conditions: 'Heat or light, Ag catalyst' },
    { name: 'Claisen Rearrangement', equation: 'Allyl vinyl ether → γ,δ-unsaturated carbonyl', type: 'Rearrangement', description: '[3,3]-Sigmatropic shift', energy: 'Endothermic', conditions: 'Heat, 200°C' },
    { name: 'Cope Rearrangement', equation: '1,5-Diene → Rearranged 1,5-diene', type: 'Rearrangement', description: '[3,3]-Sigmatropic shift', energy: 'Endothermic', conditions: 'Heat, reversible' },
    { name: 'Oxy-Cope Rearrangement', equation: '1,5-Dien-3-ol → δ,ε-unsaturated carbonyl', type: 'Rearrangement', description: 'Cope with alcohol', energy: 'Exothermic', conditions: 'Base, room temperature' },
    { name: 'Favorskii Rearrangement', equation: 'α-Halo ketone + Base → Ester/Acid', type: 'Rearrangement', description: 'Ring contraction', energy: 'Exothermic', conditions: 'Strong base' },
    { name: 'Nef Reaction', equation: 'Nitroalkane + H⁺ → Carbonyl', type: 'Hydrolysis', description: 'Nitro to carbonyl conversion', energy: 'Exothermic', conditions: 'Acid, H₂SO₄' },
    { name: 'Benzilic Acid Rearrangement', equation: 'Benzil + Base → Benzilic acid', type: 'Rearrangement', description: '1,2-Aryl migration', energy: 'Exothermic', conditions: 'Strong base, KOH' },
    { name: 'Benzoin Condensation', equation: '2ArCHO → ArCH(OH)COAr', type: 'Condensation', description: 'Self-condensation of aldehydes', energy: 'Exothermic', conditions: 'Cyanide or NHC catalyst' },
    { name: 'Claisen Condensation', equation: '2RCOOR\' → RCOCH₂COOR\'', type: 'Condensation', description: 'Ester self-condensation', energy: 'Exothermic', conditions: 'Strong base, RO⁻' },
    { name: 'Stobbe Condensation', equation: 'Ketone + Succinate → Alkylidene succinate', type: 'Condensation', description: 'Half-ester formation', energy: 'Exothermic', conditions: 'Base, sodium ethoxide' },
    { name: 'Darzens Condensation', equation: 'α-Halo ester + Carbonyl → Glycidic ester', type: 'Condensation', description: 'Epoxy ester formation', energy: 'Exothermic', conditions: 'Base, low temperature' },
    { name: 'Henry Reaction', equation: 'Nitroalkane + Aldehyde → β-Nitro alcohol', type: 'Addition', description: 'Nitroaldol reaction', energy: 'Exothermic', conditions: 'Base catalyst' },
    { name: 'Strecker Synthesis', equation: 'Aldehyde + NH₃ + HCN → α-Amino acid', type: 'Synthesis', description: 'Amino acid synthesis', energy: 'Multi-step', conditions: 'Cyanide, ammonia, then hydrolysis' },
    { name: 'Pechmann Condensation', equation: 'Phenol + β-Keto ester → Coumarin', type: 'Condensation', description: 'Coumarin synthesis', energy: 'Exothermic', conditions: 'Acid catalyst, H₂SO₄' },
    { name: 'Vilsmeier-Haack Reaction', equation: 'Arene + DMF/POCl₃ → Aryl aldehyde', type: 'Formylation', description: 'Aromatic formylation', energy: 'Exothermic', conditions: 'POCl₃, DMF' },
    { name: 'Reimer-Tiemann Reaction', equation: 'Phenol + CHCl₃/Base → Salicylaldehyde', type: 'Formylation', description: 'ortho-Formylation of phenols', energy: 'Exothermic', conditions: 'Chloroform, strong base' },
    { name: 'Gattermann-Koch Reaction', equation: 'Benzene + CO/HCl → Benzaldehyde', type: 'Formylation', description: 'Aromatic formylation', energy: 'Exothermic', conditions: 'AlCl₃, HCl, CO' },
    { name: 'Friedel-Crafts Acylation', equation: 'Benzene + RCOCl → Ar-COR', type: 'Acylation', description: 'Aromatic ketone synthesis', energy: 'Exothermic', conditions: 'AlCl₃ catalyst, acyl chloride' },
    { name: 'Fries Rearrangement', equation: 'Phenyl ester → Acyl phenol', type: 'Rearrangement', description: 'Acyl migration to ring', energy: 'Exothermic', conditions: 'AlCl₃, heat' },
    { name: 'Kolbe-Schmitt Reaction', equation: 'Phenol + CO₂ → Salicylic acid', type: 'Carboxylation', description: 'ortho-Carboxylation', energy: 'Endothermic', conditions: 'High pressure CO₂, base, heat' },
    { name: 'Balz-Schiemann Reaction', equation: 'ArN₂BF₄ → ArF', type: 'Halogenation', description: 'Aromatic fluorination', energy: 'Exothermic', conditions: 'Thermal decomposition' },
    { name: 'Sommelet Reaction', equation: 'Benzyl halide + Hexamine → Benzaldehyde', type: 'Oxidation', description: 'Benzyl to aldehyde', energy: 'Oxidative', conditions: 'Hexamethylenetetramine, water' },
    { name: 'Etard Reaction', equation: 'ArCH₃ + CrO₂Cl₂ → ArCHO', type: 'Oxidation', description: 'Chromyl chloride oxidation', energy: 'Exothermic', conditions: 'Chromyl chloride, CS₂' },
    { name: 'Rosenmund Reduction', equation: 'RCOCl + H₂ → RCHO', type: 'Reduction', description: 'Acyl chloride to aldehyde', energy: 'Exothermic', conditions: 'Pd/BaSO₄, H₂, poison' },
    { name: 'Stephen Reduction', equation: 'Nitrile + SnCl₂/HCl → Aldehyde', type: 'Reduction', description: 'Nitrile to aldehyde', energy: 'Exothermic', conditions: 'SnCl₂, HCl, then water' },
    { name: 'McFadyen-Stevens Reduction', equation: 'Acyl hydrazide → Aldehyde', type: 'Reduction', description: 'Mild reduction', energy: 'Exothermic', conditions: 'Base, heat, N₂ evolution' },
    { name: 'Bouveault-Blanc Reduction', equation: 'Ester + Na/EtOH → 2 Alcohols', type: 'Reduction', description: 'Dissolving metal reduction', energy: 'Exothermic', conditions: 'Sodium, ethanol' },
    { name: 'DIBAL Reduction', equation: 'Ester → Aldehyde', type: 'Reduction', description: 'Partial reduction of esters', energy: 'Exothermic', conditions: 'Diisobutylaluminum hydride, -78°C' },
    { name: 'Luche Reduction', equation: 'Enone → Allylic alcohol', type: 'Reduction', description: 'Selective 1,2-reduction', energy: 'Exothermic', conditions: 'NaBH₄, CeCl₃, methanol' },
    { name: 'Meerwein-Ponndorf-Verley', equation: 'Ketone + Al(OR)₃ → Alcohol', type: 'Reduction', description: 'Aluminum alkoxide reduction', energy: 'Exothermic', conditions: 'Aluminum isopropoxide, reflux' },
    { name: 'Oppenauer Oxidation', equation: 'Alcohol + Ketone → Ketone + Alcohol', type: 'Oxidation', description: 'Reverse of MPV reduction', energy: 'Equilibrium', conditions: 'Aluminum tert-butoxide, acetone' },
    { name: 'Dess-Martin Oxidation', equation: 'Alcohol → Carbonyl', type: 'Oxidation', description: 'Mild periodinane oxidation', energy: 'Exothermic', conditions: 'Dess-Martin periodinane, CH₂Cl₂' },
    { name: 'TEMPO Oxidation', equation: 'Alcohol → Carbonyl', type: 'Oxidation', description: 'Catalytic nitroxyl radical oxidation', energy: 'Exothermic', conditions: 'TEMPO, bleach or PhI(OAc)₂' },
    { name: 'Sarett Oxidation', equation: 'Alcohol → Carbonyl', type: 'Oxidation', description: 'Chromium trioxide oxidation', energy: 'Exothermic', conditions: 'CrO₃-pyridine complex' },
    { name: 'Collins Oxidation', equation: 'Alcohol → Carbonyl', type: 'Oxidation', description: 'CrO₃-pyridine oxidation', energy: 'Exothermic', conditions: 'CrO₃·2Py, CH₂Cl₂' },
    { name: 'Corey-Chaykovsky Reaction', equation: 'Carbonyl + Sulfur ylide → Epoxide', type: 'Epoxidation', description: 'Ylide epoxidation', energy: 'Exothermic', conditions: 'Dimethylsulfonium methylide' },
    { name: 'Simmons-Smith Reaction', equation: 'Alkene + CH₂I₂/Zn → Cyclopropane', type: 'Cyclopropanation', description: 'Carbenoid cyclopropanation', energy: 'Exothermic', conditions: 'CH₂I₂, Zn-Cu couple' },
    { name: 'Pauson-Khand Reaction', equation: 'Alkyne + Alkene + CO → Cyclopentenone', type: 'Cycloaddition', description: '[2+2+1] Cycloaddition', energy: 'Exothermic', conditions: 'Co₂(CO)₈ catalyst, heat' },
    { name: 'Tebbe Olefination', equation: 'Ester/Amide → Enol ether/Enamine', type: 'Olefination', description: 'Titanium-based methylenation', energy: 'Exothermic', conditions: 'Tebbe reagent, THF' },
    { name: 'Peterson Olefination', equation: 'Carbonyl + α-Silyl carbanion → Alkene', type: 'Olefination', description: 'Silicon-based olefination', energy: 'Exothermic', conditions: 'Base or acid elimination' },
    { name: 'Julia Olefination', equation: 'Carbonyl + Sulfone → Alkene', type: 'Olefination', description: 'Sulfone-based olefination', energy: 'Multi-step', conditions: 'Base, reductive elimination' },
    { name: 'Takai Olefination', equation: 'Aldehyde + CHBr₃/Cr → Vinyl bromide', type: 'Olefination', description: 'Chromium-mediated', energy: 'Exothermic', conditions: 'CrCl₂, THF' },
    { name: 'Corey-Fuchs Reaction', equation: 'Aldehyde → Terminal alkyne', type: 'Alkynylation', description: 'Two-step alkyne synthesis', energy: 'Multi-step', conditions: 'CBr₄, PPh₃, then BuLi' },
    { name: 'Seyferth-Gilbert Homologation', equation: 'Aldehyde/Ketone → Alkyne', type: 'Alkynylation', description: 'One-carbon homologation', energy: 'Exothermic', conditions: 'Bestmann-Ohira reagent, base' },
    { name: 'Appel Reaction', equation: 'Alcohol + PPh₃/CCl₄ → Alkyl chloride', type: 'Halogenation', description: 'Mild halogenation', energy: 'Exothermic', conditions: 'Triphenylphosphine, CCl₄' },
    { name: 'Mitsunobu Reaction', equation: 'Alcohol + Nucleophile → Substituted product', type: 'Substitution', description: 'Inversion of configuration', energy: 'Exothermic', conditions: 'PPh₃, DEAD, nucleophile' },
    { name: 'Finkelstein Reaction', equation: 'R-X + NaI → R-I', type: 'Halogen Exchange', description: 'Halide exchange', energy: 'Equilibrium', conditions: 'Acetone, sodium iodide' },
    { name: 'Hunsdiecker Reaction', equation: 'RCOOAg + Br₂ → R-Br + CO₂', type: 'Decarboxylation', description: 'Decarboxylative halogenation', energy: 'Exothermic', conditions: 'Silver salt, halogen, CCl₄' },
    { name: 'Barton Decarboxylation', equation: 'RCOOH → R-H', type: 'Decarboxylation', description: 'Radical decarboxylation', energy: 'Photochemical', conditions: 'Light, thiohydroxamate ester' },
    { name: 'Kochi Decarboxylation', equation: 'RCOOPb(OAc)₄ → R-OCOR', type: 'Decarboxylation', description: 'Oxidative decarboxylation', energy: 'Exothermic', conditions: 'Lead tetraacetate' },
    { name: 'Arndt-Eistert Synthesis', equation: 'Acid → Homologated acid', type: 'Homologation', description: 'One-carbon chain extension', energy: 'Multi-step', conditions: 'Diazo compound, Wolff rearrangement' },
    { name: 'Passerini Reaction', equation: 'Aldehyde + Acid + Isocyanide → α-Acyloxyamide', type: 'Three-component', description: 'Multicomponent reaction', energy: 'Exothermic', conditions: 'Room temperature, no catalyst' },
    { name: 'Ugi Reaction', equation: 'Aldehyde + Amine + Acid + Isocyanide → α-Aminoacylamide', type: 'Four-component', description: 'Multicomponent reaction', energy: 'Exothermic', conditions: 'Methanol, room temperature' },
    { name: 'Hantzsch Synthesis', equation: 'β-Keto ester + Aldehyde + NH₃ → Dihydropyridine', type: 'Heterocycle synthesis', description: 'Pyridine synthesis', energy: 'Exothermic', conditions: 'Heat, ethanol' },
    { name: 'Biginelli Reaction', equation: 'Urea + Aldehyde + β-Keto ester → Dihydropyrimidinone', type: 'Three-component', description: 'Heterocycle synthesis', energy: 'Exothermic', conditions: 'Acid catalyst, heat' },
    { name: 'Paal-Knorr Synthesis', equation: '1,4-Dicarbonyl + Amine → Pyrrole', type: 'Heterocycle synthesis', description: 'Pyrrole synthesis', energy: 'Exothermic', conditions: 'Acid catalyst, heat' },
    { name: 'Fischer Indole Synthesis', equation: 'Phenylhydrazine + Ketone → Indole', type: 'Heterocycle synthesis', description: 'Indole synthesis', energy: 'Exothermic', conditions: 'Acid, heat' },
    { name: 'Pictet-Spengler Reaction', equation: 'Tryptamine + Aldehyde → Tetrahydro-β-carboline', type: 'Cyclization', description: 'Alkaloid synthesis', energy: 'Exothermic', conditions: 'Acid catalyst' },
    { name: 'Bischler-Napieralski Reaction', equation: 'β-Arylethylamine + Acid chloride → Isoquinoline', type: 'Cyclization', description: 'Isoquinoline synthesis', energy: 'Exothermic', conditions: 'POCl₃ or P₂O₅, heat' },
    { name: 'Pomeranz-Fritsch Reaction', equation: 'Benzaldehyde acetal + Amino acetal → Isoquinoline', type: 'Cyclization', description: 'Isoquinoline synthesis', energy: 'Exothermic', conditions: 'Acid, heat' },
    { name: 'Skraup Synthesis', equation: 'Aniline + Glycerol → Quinoline', type: 'Heterocycle synthesis', description: 'Quinoline synthesis', energy: 'Exothermic', conditions: 'H₂SO₄, oxidant, heat' },
    { name: 'Doebner-Miller Reaction', equation: 'Aniline + α,β-Unsaturated carbonyl → Quinoline', type: 'Heterocycle synthesis', description: 'Quinoline variant', energy: 'Exothermic', conditions: 'Acid catalyst' },
    { name: 'Friedländer Synthesis', equation: 'o-Aminobenzaldehyde + Ketone → Quinoline', type: 'Heterocycle synthesis', description: 'Quinoline synthesis', energy: 'Exothermic', conditions: 'Base catalyst' }
  ],
  terms: [
    { term: 'Acid', category: 'General Chemistry', definition: 'A substance that donates protons (H⁺) in solution or accepts electron pairs, has pH less than 7', example: 'Hydrochloric acid (HCl), Sulfuric acid (H₂SO₄), Acetic acid (CH₃COOH)' },
    { term: 'Activation Energy', category: 'Chemical Kinetics', definition: 'Minimum energy required for reactants to undergo a chemical reaction', example: 'Catalysts lower activation energy, speeding up reactions' },
    ...
    { term: 'Yield', category: 'Stoichiometry', definition: 'Amount of product obtained from chemical reaction', example: 'Actual yield vs theoretical yield, percent yield' },
    { term: 'Zwitterion', category: 'Organic Chemistry', definition: 'Molecule with both positive and negative charges', example: 'Amino acids at physiological pH' },
    { term: 'Amphoteric', category: 'Acid-Base Chemistry', definition: 'Substance that can act as both acid and base', example: 'Water, amino acids, aluminum hydroxide' },
    { term: 'Azeotrope', category: 'Physical Chemistry', definition: 'Mixture with constant boiling point', example: '95.6% ethanol-water mixture' },
    { term: 'Boltzmann Distribution', category: 'Physical Chemistry', definition: 'Statistical distribution of molecular energies', example: 'Temperature-dependent energy distribution' },
    { term: 'Boyle\'s Law', category: 'Gas Laws', definition: 'At constant T, pressure inversely proportional to volume (P₁V₁ = P₂V₂)', example: 'Compressing gas increases pressure' },
    { term: 'Charles\' Law', category: 'Gas Laws', definition: 'At constant P, volume proportional to temperature (V₁/T₁ = V₂/T₂)', example: 'Heating gas expands volume' },
    { term: 'Chemiluminescence', category: 'Physical Chemistry', definition: 'Light emission from chemical reaction', example: 'Glow sticks, fireflies' },
    { term: 'Chiral Center', category: 'Stereochemistry', definition: 'Atom bonded to four different groups', example: 'Central carbon in amino acids' },
    { term: 'Chromophore', category: 'Spectroscopy', definition: 'Part of molecule responsible for color', example: 'C=C, C=O, benzene ring' },
    { term: 'Colligative Properties', category: 'Solutions', definition: 'Properties depending on particle number, not identity', example: 'Boiling point elevation, freezing point depression' },
    { term: 'Conjugate Acid-Base Pair', category: 'Acid-Base Chemistry', definition: 'Pair differing by one proton', example: 'HCl/Cl⁻, H₂O/OH⁻, NH₄⁺/NH₃' },
    { term: 'Coordinate Covalent Bond', category: 'Chemical Bonding', definition: 'Bond where both electrons come from one atom', example: 'NH₃-BF₃, H₃O⁺' },
    { term: 'Corrosion', category: 'Electrochemistry', definition: 'Oxidative degradation of metals', example: 'Rusting of iron' },
    { term: 'Critical Point', category: 'Phase Transitions', definition: 'Temperature and pressure where liquid-gas distinction disappears', example: 'Water: 374°C, 218 atm' },
    { term: 'Cyclotron', category: 'Nuclear Chemistry', definition: 'Particle accelerator using magnetic field', example: 'Medical isotope production' },
    { term: 'Dalton\'s Law', category: 'Gas Laws', definition: 'Total pressure equals sum of partial pressures', example: 'P_total = P₁ + P₂ + P₃' },
    { term: 'Delocalization', category: 'Chemical Bonding', definition: 'Electrons spread over multiple atoms', example: 'Benzene ring, carbonate ion' },
    { term: 'Diastereomers', category: 'Stereochemistry', definition: 'Non-mirror-image stereoisomers', example: 'cis/trans-2-butene' },
    { term: 'Dielectric Constant', category: 'Physical Chemistry', definition: 'Measure of solvent polarity', example: 'Water: 78.5, hexane: 1.9' },
    { term: 'Disproportionation', category: 'Redox Chemistry', definition: 'Simultaneous oxidation and reduction of same species', example: '2Cu⁺ → Cu²⁺ + Cu' },
    { term: 'Dynamic Equilibrium', category: 'Chemical Equilibrium', definition: 'Forward and reverse rates are equal', example: 'N₂ + 3H₂ ⇌ 2NH₃' },
    { term: 'Effusion', category: 'Gas Laws', definition: 'Gas escape through tiny hole', example: 'Graham\'s law of effusion' },
    { term: 'Electromagnetic Spectrum', category: 'Spectroscopy', definition: 'Range of all electromagnetic radiation', example: 'γ-rays, X-rays, UV, visible, IR, microwaves, radio' },
    { term: 'Electron Affinity', category: 'Atomic Structure', definition: 'Energy change when electron added to atom', example: 'Cl + e⁻ → Cl⁻ + energy' },
    { term: 'Electroplating', category: 'Electrochemistry', definition: 'Using electricity to coat object with metal', example: 'Chrome plating, gold plating' },
    { term: 'Enantiomers', category: 'Stereochemistry', definition: 'Non-superimposable mirror images', example: 'L and D amino acids' },
    { term: 'Endergonic', category: 'Thermodynamics', definition: 'Non-spontaneous reaction, ΔG > 0', example: 'Photosynthesis' },
    { term: 'Enol', category: 'Organic Chemistry', definition: 'Tautomer with C=C-OH structure', example: 'Keto-enol tautomerism in acetone' },
    { term: 'Ester Hydrolysis', category: 'Organic Chemistry', definition: 'Breaking ester with water', example: 'Saponification of fats' },
    { term: 'Eutectic Point', category: 'Phase Diagrams', definition: 'Lowest melting point of mixture', example: 'Salt-ice mixture' },
    { term: 'Exergonic', category: 'Thermodynamics', definition: 'Spontaneous reaction, ΔG < 0', example: 'Combustion, ATP hydrolysis' },
    { term: 'Faraday Constant', category: 'Electrochemistry', definition: 'Charge per mole of electrons (96,485 C/mol)', example: 'Used in electrolysis calculations' },
    { term: 'First Order Reaction', category: 'Chemical Kinetics', definition: 'Rate proportional to one reactant concentration', example: 'Radioactive decay, rate = k[A]' },
    { term: 'Formal Charge', category: 'Chemical Bonding', definition: 'Charge assigned to atom in molecule', example: 'FC = V - (L + B/2)' },
    { term: 'Galvanization', category: 'Electrochemistry', definition: 'Coating iron with zinc', example: 'Protecting steel from rust' },
    { term: 'Geometric Isomers', category: 'Stereochemistry', definition: 'Different spatial arrangement around double bond', example: 'cis-trans isomers' },
    { term: 'Graham\'s Law', category: 'Gas Laws', definition: 'Rate of effusion inversely proportional to √Molar mass', example: 'Lighter gases effuse faster' },
    { term: 'Greenhouse Effect', category: 'Environmental Chemistry', definition: 'Trapping of heat by atmospheric gases', example: 'CO₂, CH₄, N₂O trap IR radiation' },
    { term: 'Half-Reaction', category: 'Electrochemistry', definition: 'Oxidation or reduction part of redox reaction', example: 'Zn → Zn²⁺ + 2e⁻' },
    { term: 'Heisenberg Uncertainty Principle', category: 'Quantum Chemistry', definition: 'Cannot know position and momentum simultaneously', example: 'ΔxΔp ≥ h/4π' },
    { term: 'Hess\'s Law', category: 'Thermodynamics', definition: 'Total enthalpy change independent of pathway', example: 'ΔH = ΔH₁ + ΔH₂ + ΔH₃' },
    { term: 'Hybrid Orbital', category: 'Chemical Bonding', definition: 'Mixed atomic orbitals for bonding', example: 'sp³ (CH₄), sp² (C₂H₄), sp (C₂H₂)' },
    { term: 'Hydrophilic', category: 'Physical Chemistry', definition: 'Water-loving, polar substances', example: 'Sugars, salts, amino acids' },
    { term: 'Hydrophobic', category: 'Physical Chemistry', definition: 'Water-fearing, non-polar substances', example: 'Oils, fats, hydrocarbons' },
    { term: 'Ideal Gas', category: 'Gas Laws', definition: 'Hypothetical gas obeying PV = nRT perfectly', example: 'Real gases approximate at low P, high T' },
    { term: 'Inductive Effect', category: 'Organic Chemistry', definition: 'Electron density shift through σ bonds', example: '-I effect of halogens' },
    { term: 'Interfacial Tension', category: 'Physical Chemistry', definition: 'Force between two immiscible liquids', example: 'Oil-water interface' },
    { term: 'Isoelectronic', category: 'Atomic Structure', definition: 'Species with same electron configuration', example: 'N³⁻, O²⁻, F⁻, Ne, Na⁺ (all 10e⁻)' },
    { term: 'Lattice Energy', category: 'Ionic Bonding', definition: 'Energy to separate ionic solid into gaseous ions', example: 'NaCl(s) → Na⁺(g) + Cl⁻(g)' },
    { term: 'Lewis Acid', category: 'Acid-Base Chemistry', definition: 'Electron pair acceptor', example: 'BF₃, AlCl₃, Fe³⁺' },
    { term: 'Lewis Base', category: 'Acid-Base Chemistry', definition: 'Electron pair donor', example: 'NH₃, H₂O, Cl⁻' },
    { term: 'Ligand', category: 'Coordination Chemistry', definition: 'Molecule/ion bonded to central metal', example: 'H₂O, NH₃, CN⁻ in complexes' },
    { term: 'Markovnikov\'s Rule', category: 'Organic Chemistry', definition: 'In addition, H adds to carbon with more H atoms', example: 'HBr + propene → 2-bromopropane' },
    { term: 'Mass Action Law', category: 'Chemical Equilibrium', definition: 'K = [products]/[reactants] at equilibrium', example: 'K = [C]^c[D]^d / [A]^a[B]^b' },
    { term: 'Mesomeric Effect', category: 'Organic Chemistry', definition: 'Electron delocalization through π bonds', example: 'Resonance in benzene' },
    { term: 'Molecular Orbital', category: 'Chemical Bonding', definition: 'Orbital formed from atomic orbitals', example: 'σ (bonding), σ* (antibonding)' },
    { term: 'Nucleophile', category: 'Organic Chemistry', definition: 'Electron-rich species seeking positive center', example: 'OH⁻, CN⁻, NH₃, H₂O' },
    { term: 'Nucleophilic Substitution', category: 'Organic Chemistry', definition: 'Nucleophile replaces leaving group', example: 'SN1, SN2 reactions' },
    { term: 'Optical Activity', category: 'Stereochemistry', definition: 'Rotation of plane-polarized light', example: 'Chiral molecules are optically active' },
    { term: 'Osmosis', category: 'Solutions', definition: 'Solvent flow across semipermeable membrane', example: 'Water moving into cells' },
    { term: 'Osmotic Pressure', category: 'Solutions', definition: 'Pressure to stop osmosis, π = MRT', example: 'Cell turgor pressure' },
    { term: 'Pauli Exclusion Principle', category: 'Quantum Chemistry', definition: 'No two electrons have identical quantum numbers', example: 'Max 2 electrons per orbital' },
    { term: 'Peptide Bond', category: 'Biochemistry', definition: 'Amide bond linking amino acids', example: 'Protein backbone -CO-NH-' },
    { term: 'Phosphorescence', category: 'Physical Chemistry', definition: 'Delayed light emission after excitation', example: 'Glow-in-the-dark materials' },
    { term: 'Polar Covalent Bond', category: 'Chemical Bonding', definition: 'Unequal electron sharing due to electronegativity difference', example: 'H-Cl, H-O bonds' },
    { term: 'Polymerization', category: 'Polymer Chemistry', definition: 'Monomers joining to form polymer', example: 'Ethylene → polyethylene' },
    { term: 'Principal Quantum Number', category: 'Quantum Chemistry', definition: 'n = energy level, 1, 2, 3...', example: 'n=1 is closest to nucleus' },
    { term: 'Racemic Mixture', category: 'Stereochemistry', definition: '50:50 mixture of enantiomers, optically inactive', example: 'D,L-alanine mixture' },
    { term: 'Raoult\'s Law', category: 'Solutions', definition: 'Vapor pressure lowering proportional to mole fraction', example: 'P = X_solvent × P°' },
    { term: 'Rate-Determining Step', category: 'Chemical Kinetics', definition: 'Slowest step in reaction mechanism', example: 'Controls overall reaction rate' },
    { term: 'Reaction Intermediate', category: 'Chemical Kinetics', definition: 'Species formed and consumed in mechanism', example: 'Carbocation in SN1' },
    { term: 'Reaction Quotient', category: 'Chemical Equilibrium', definition: 'Q = [products]/[reactants] at any time', example: 'Compare Q to K to predict direction' },
    { term: 'Resonance Hybrid', category: 'Chemical Bonding', definition: 'Weighted average of resonance structures', example: 'Benzene is hybrid of two Kekulé structures' },
    { term: 'Saponification', category: 'Organic Chemistry', definition: 'Base hydrolysis of fats to soap', example: 'Fat + NaOH → soap + glycerol' },
    { term: 'Saturated Hydrocarbon', category: 'Organic Chemistry', definition: 'Hydrocarbon with only single bonds', example: 'Alkanes: CH₄, C₂H₆, C₃H₈' },
    { term: 'Second Order Reaction', category: 'Chemical Kinetics', definition: 'Rate proportional to [A]² or [A][B]', example: 'Rate = k[A]² or k[A][B]' },
    { term: 'Sigma Bond', category: 'Chemical Bonding', definition: 'End-to-end orbital overlap, single bond', example: 'C-C, C-H bonds' },
    { term: 'Spin Quantum Number', category: 'Quantum Chemistry', definition: 's = +½ or -½, electron spin', example: 'Up or down arrows in orbital diagram' },
    { term: 'Standard State', category: 'Thermodynamics', definition: '1 atm, 25°C, 1 M concentration', example: 'Reference for thermodynamic values' },
    { term: 'Stereoisomers', category: 'Stereochemistry', definition: 'Same connectivity, different 3D arrangement', example: 'Enantiomers, diastereomers' },
    { term: 'Steric Hindrance', category: 'Organic Chemistry', definition: 'Crowding preventing reaction', example: 'tert-Butyl groups block approach' },
    { term: 'Surface Tension', category: 'Physical Chemistry', definition: 'Force at liquid surface due to cohesion', example: 'Water beads on waxed surface' },
    { term: 'Tautomerism', category: 'Organic Chemistry', definition: 'Isomers in rapid equilibrium', example: 'Keto-enol: CH₃COCH₃ ⇌ CH₂=C(OH)CH₃' },
    { term: 'Thermite Reaction', category: 'Redox Chemistry', definition: 'Highly exothermic Al + Fe₂O₃ reaction', example: 'Used for welding rails' },
    { term: 'Transition State', category: 'Chemical Kinetics', definition: 'Highest energy point on reaction coordinate', example: 'Activated complex at peak' },
    { term: 'Triple Point', category: 'Phase Diagrams', definition: 'Temperature and pressure where 3 phases coexist', example: 'Water: 0.01°C, 0.006 atm' },
    { term: 'Unsaturated Hydrocarbon', category: 'Organic Chemistry', definition: 'Hydrocarbon with double or triple bonds', example: 'Alkenes, alkynes' },
    { term: 'Van\'t Hoff Factor', category: 'Solutions', definition: 'Ratio of particles in solution to formula units', example: 'i = 1 (glucose), i = 2 (NaCl)' },
    { term: 'Vapor Pressure', category: 'Physical Chemistry', definition: 'Pressure of vapor in equilibrium with liquid', example: 'Increases with temperature' },
    { term: 'VSEPR Theory', category: 'Molecular Geometry', definition: 'Valence Shell Electron Pair Repulsion - predicts molecular shape', example: 'CH₄ tetrahedral, H₂O bent' },
    { term: 'Wave Function', category: 'Quantum Chemistry', definition: 'ψ describes electron probability distribution', example: '|ψ|² gives probability density' },
    { term: 'Weak Acid', category: 'Acid-Base Chemistry', definition: 'Partially ionizes in water', example: 'CHゃCOOH, H₂CO₃, HF' },
    { term: 'Weak Base', category: 'Acid-Base Chemistry', definition: 'Partially accepts protons', example: 'NH₃, CH₃NH₂, pyridine' },
    { term: 'Work Function', category: 'Photoelectrochemistry', definition: 'Minimum energy to remove electron from solid', example: 'Used in photoelectric effect' },
    { term: 'Zero Order Reaction', category: 'Chemical Kinetics', definition: 'Rate independent of reactant concentration', example: 'Rate = k (enzyme-saturated reactions)' },
    { term: 'Zeta Potential', category: 'Colloid Chemistry', definition: 'Electrical potential at particle surface', example: 'Determines colloid stability' }
  ],
  functionalGroups: [
  ...
  featuredFacts: [
    ...
    { fact: 'Tungsten has the highest melting point of all metals at 3,422°C, used in light bulb filaments', category: 'Elements' },
    { fact: 'Osmium is the densest naturally occurring element at 22.59 g/cm³, twice as dense as lead', category: 'Elements' },
    { fact: 'Glass is technically a supercooled liquid, not a solid, flowing extremely slowly over centuries', category: 'Materials' },
    { fact: 'The smell of rain (petrichor) comes from oils released by plants during dry periods, absorbed by rocks and soil', category: 'Organic Chemistry' },
    { fact: 'Helium is the only element discovered in space (Sun\'s spectrum) before being found on Earth', category: 'History' },
    { fact: 'Water is the only substance that naturally exists in all three states (solid, liquid, gas) on Earth', category: 'Physical Chemistry' },
    { fact: 'The human body contains about 0.2 milligrams of gold, mostly in blood', category: 'Body Chemistry' },
    { fact: 'A single teaspoon of a neutron star weighs about 6 billion tons due to extreme density', category: 'Nuclear Chemistry' },
    { fact: 'Lightning can reach temperatures of 30,000 Kelvin, five times hotter than the Sun\'s surface', category: 'Energy' },
    { fact: 'Gallium will melt in your hand at 29.76°C but has a boiling point of 2,204°C - huge liquid range', category: 'Elements' },
    { fact: 'The average pencil can draw a line 35 miles long or write approximately 45,000 words', category: 'Materials' },
    { fact: 'Honey never spoils - 3,000-year-old honey found in Egyptian tombs was still edible', category: 'Organic Chemistry' },
    { fact: 'Graphene is 200 times stronger than steel but only one atom thick', category: 'Materials' },
    { fact: 'Hot water can freeze faster than cold water under certain conditions (Mpemba effect)', category: 'Physical Chemistry' },
    { fact: 'Sulfuric acid is the most produced chemical in the world, over 200 million tons annually', category: 'Industrial' }
  ]
};
